...
async function runText(input) {
    ...
    return wrapOk(TOOL_NAME, { ...input, limit }, { hits, total }, summary, preview_markdown, canonical_revision, undefined, response.duration_ms);
}
function buildTextPreview(pattern, hits, total) {
    if (total === 0) {
...
//# sourceMappingURL=ix_text.js.map